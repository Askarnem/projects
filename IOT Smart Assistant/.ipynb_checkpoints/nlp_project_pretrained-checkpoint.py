...
model.load_state_dict(torch.load('/Users/askarnemaev/Desktop/Masters/NLP/project/project compile/AlbertModelparams.pt',  map_location=torch.device('cpu')))
...
while True:
    ...
    if event == "Speak":
        ...
        if predict_com == 'spotify':
            ...
            setup = pd.read_csv('/Users/askarnemaev/Desktop/Masters/NLP/project/project compile/setup.txt', sep='=', index_col=0, squeeze=True, header=None)
